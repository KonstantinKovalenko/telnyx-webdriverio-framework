...
class ContactUsPage extends BasePage {
    ...
    get signupEmail() {return $('#sign-up-email')}
    get signupFirstname() {return $('#sign-up-first-name')}
    get signupLastname() {return $('#sign-up-last-name')}
    get signupPassword() {return $('#sign-up-password')}
